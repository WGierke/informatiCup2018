...
sys.path.append('..')
from config import TESTS_DATA_PATH, PROCESSED_PATH, MODEL_PATH, GAS_PRICE_PATH, GAS_STATIONS_PATH
...
def train(gas_station_id=DEFAULT_GAS_STATION_ID, up_to_days=None, up_to_timestamp=None, cache=True):
    ...
    if os.environ.get('CI', False):
        gas_station_path = os.path.join(TESTS_DATA_PATH, "{}.csv".format(gas_station_id))
